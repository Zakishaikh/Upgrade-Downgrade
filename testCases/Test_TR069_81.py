...
class Test_TR069_81:
    ...
    no_rows = 1
    result = 0
    testcase_name = "test_TR069_81"
    rownum_Start = 84
    rownum_Finish = 84
    column_no = 5
    str_DiagnosticState = 'Requested'
    str_HostName = 'asdahsdhslah.com'
    str_MaxHopCount = '221'
    list_deviceinfo = []
    list_task_status = []
    logger = LogGen.loggen()

    def test_TR069_81(self, setup):
        try:
            ...
            self.av.setIPDiagnosticsTraceRouteMaxHopCount(self.str_MaxHopCount)
    ...
    def test_TR069_81_excel(self, setup):
