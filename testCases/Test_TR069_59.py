...
class Test_TR069_59:
    ...
    def test_TR069_59(self, setup):
        try:
            ...
            self.av.clickTableheadIPInterface1IPv6()
            self.av.clickTabledataIPInterface1IPv61()
            str_ipv6 = self.av.getTextdataIPInterface1IPv61()
            print(str_ipv6)
            ...
            if str_ipv6.count(':') > 1:
                ...
                self.logger.info('********************* Address not in IPv6 Format *********************')
    ...
    def test_TR069_59_excel(self, setup):
