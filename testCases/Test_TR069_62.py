...
class Test_TR069_62:
    ...
    str_HostName = 'youtube.com'
    str_NoOfRepetitions = '1'
    logger = LogGen.loggen()

    def test_TR069_62(self, setup):
        try:
            ...
            self.av.clickTableheadDNSDiagnostics()
            self.av.clickTabledataNSLookupDiagnostics()
            ...
            self.av.setDNSDiagnosticState(self.str_DiagnosticState)
            self.av.setDNSHostName(self.str_HostName)
            self.av.setDNSNoOfRepetitions(self.str_NoOfRepetitions)
            ...
            self.av.clickTableheadDNS()
            self.av.clickTableheadDNSDiagnostics()
            self.av.clickTableheadNSLookupDiagnostics()
            self.av.clickTabledataDNSResult()
            self.acs.TR069_Getcurrent()
    ...
    def test_TR069_62_excel(self, setup):
