...
class Test_TR069_92:
    ...
    def test_TR069_92(self, setup):
        try:
            ...
            self.av.ClickTableHeadAccespoint(4)
            self.av.ClickTabledataAccespointAssociatedDevice(4)
    ...
    def test_TR069_92_excel(self, setup):
