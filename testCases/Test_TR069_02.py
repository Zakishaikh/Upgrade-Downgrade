...
class Test_TR069_02:
    ...
    def test_TR069_02(self, setup):
        try:
            ...
            for i in range(2):
                ...
                self.logger.info(
                    '************* Current Software Version = ' + str_CurrentSoftware + ' *************')
                ...
                self.list_status.append(self.acs.TR069_TaskStatusRebootReset())
                print(self.list_status[i])
                if self.list_status[i] == 'PASS':
                    self.logger.info(
            ...
            self.logger.info(self.list_status)
            if 'FAIL' in self.list_status:
    ...
    def test_TR069_02_excel(self, setup):
