...
class Test_TR069_10:
    ...
    rownum_Finish = 11
    column_no = 5
    testcase_name = "test_TR069_ACS_10"
    no_rows = 1
    result = 0
    ...
    def test_TR069_10(self, setup):
        try:
            ...
            self.av.clickTableHeadInterface2()
            self.av.clickTabledataInterface2Stats()

            self.int_bytesreceived = self.av.getTextdataInterface2StatsBytesReceived()
            self.int_bytessent = self.av.getTextdataInterface2StatsBytesSend()
            ...
            self.int_bytesreceived_yt = self.av.getTextdataInterface2StatsBytesReceived()
            self.int_bytessent_yt = self.av.getTextdataInterface2StatsBytesSend()
    ...
    def test_TR069_10_excel(self, setup):
