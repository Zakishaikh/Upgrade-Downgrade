...
class Test_TR069_90:
    ...
    def test_TR069_90(self, setup):
        try:
            ...
            self.av.ClickTableHeadAccespoint(2)
            self.av.ClickTabledataAccespointAssociatedDevice(2)
    ...
    def test_TR069_90_excel(self, setup):
