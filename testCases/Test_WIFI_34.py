...
class Test_WIFI_34:
    ...
    result = 0
    no_rows = 1
    testcase_name = "test_WIFI_34"
    logger = LogGen.loggen()
    int_SSIDNo = 1
    str_WirelessBand = '2.4GHZ'
    str_WirelessName = ' Test_34 IDCPE 01'
    list_screenshot = []
    list_deviceinfo = []
    ...
    def test_WIFI_34(self, setup):
        try:
            ...
            if x == 'Connected':
                ...
                SSID = self.gui.getSSID1Name()
                SSIDConfigSet.setSSIDNAME(str(self.int_SSIDNo), SSID)
    ...
    def test_WIFI_34_excel(self, setup):
