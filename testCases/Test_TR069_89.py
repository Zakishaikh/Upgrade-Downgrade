...
class Test_TR069_89:
    ...
    def test_TR069_89(self, setup):
        try:
            ...
            self.av.ClickTableHeadAccespoint(1)
            self.av.ClickTabledataAccespointAssociatedDevice(1)
    ...
    def test_TR069_89_excel(self, setup):
