...
class Test_TR069_91:
    ...
    def test_TR069_91(self, setup):
        try:
            ...
            self.av.ClickTableHeadAccespoint(3)
            self.av.ClickTabledataAccespointAssociatedDevice(3)
    ...
    def test_TR069_91_excel(self, setup):
