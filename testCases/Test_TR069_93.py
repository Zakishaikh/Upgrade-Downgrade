...
class Test_TR069_93:
    ...
    def test_TR069_93(self, setup):
        try:
            ...
            self.av.ClickTableHeadAccespoint(5)
            self.av.ClickTabledataAccespointAssociatedDevice(5)
    ...
    def test_TR069_93_excel(self, setup):
